    ...
    <div class="auth-form-panel">
        <div class="auth-form-content" style="text-align: center;">
            ...
            <div style="margin: 2rem 0;">
                <div style="font-size: 6rem; font-weight: 700; color: var(--primary);">404</div>
                <h1 style="font-size: 1.5rem; margin: 1rem 0 0.5rem;">Page Not Found</h1>
                <p style="color: var(--text-muted);">Sorry, the page you are looking for does not exist.</p>
            </div>
