...
<div class="hero-section">
    ...
    <div class="hero-content">
        <h1 class="hero-title">Make 'Em Laugh</h1>
        <p class="hero-subtitle">Describe your topic — we'll write the punchline</p>
        <div class="search-bar">
            <div class="template-dropdown" id="templateDropdown">
                <button type="button" class="template-dropdown-trigger" id="dropdownTrigger">
                    <span id="selectedTemplateName">Pick One</span>
                    <i class="fas fa-chevron-down"></i>
                </button>
                <div class="template-dropdown-menu" id="dropdownMenu">
                    @foreach($categories as $category)
                        <div class="template-dropdown-header">{{ $category->name }}</div>
                        @foreach($category->templates as $template)
                            <div class="template-dropdown-item" data-id="{{ $template->id }}" data-name="{{ $template->name }}">
                                {{ $template->name }}
                            </div>
                        @endforeach
                    @endforeach
            ...
            <input type="text" id="jokePrompt" placeholder="Describe your topic..." class="search-input">
        ...
        <div class="joke-display" id="jokeDisplay" style="display: none;">
            <div class="joke-quote">
                <button class="dismiss-btn" id="dismissJokeBtn">
