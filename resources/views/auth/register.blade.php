    ...
    <div class="flex min-h-screen">
        <div class="flex w-full lg:w-1/2 items-center justify-center bg-[#0a0a1a] p-8 lg:p-12">
            <div class="w-full max-w-md">
                <div class="mb-10 text-center">
                    ...
                    <h1 class="mb-2 text-3xl font-bold bg-gradient-to-r from-white to-white/70 bg-clip-text text-transparent">Create account</h1>
                    <p class="bg-gradient-to-r from-[#ff2d95] via-[#8f4de0] to-[#ff6bb5] bg-[length:200%_auto] bg-clip-text text-transparent animate-[shimmer_3s_linear_infinite]">Start your journey today</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-6">
                        <label class="mb-2 block text-sm font-semibold text-white/70" for="name">Name</label>
                        <div class="relative">
                            ...
                            <input id="name" class="w-full rounded-2xl border border-white/10 bg-white/5 pl-12 pr-4 py-3.5 text-white placeholder-white/30 transition-all focus:border-[#ff2d95] focus:outline-none focus:ring-4 focus:ring-[#ff2d95]/20" type="text" name="name" value="{{ old('name') }}" placeholder="John Doe" required autofocus autocomplete="name">
                        </div>
                        <x-input-error :messages="$errors->get('name')" class="mt-2 text-sm text-[#ff2d95]" />
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input id="email" class="w-full rounded-2xl border border-white/10 bg-white/5 pl-12 pr-4 py-3.5 text-white placeholder-white/30 transition-all focus:border-[#ff2d95] focus:outline-none focus:ring-4 focus:ring-[#ff2d95]/20" type="email" name="email" value="{{ old('email') }}" placeholder="name@example.com" required autocomplete="username">
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <a class="text-sm font-medium text-[#8f4de0] transition-all hover:text-[#ff2d95] hover:underline" href="{{ route('login') }}">
                            Already registered?
                        </a>
                        <button type="submit" class="group relative rounded-2xl bg-gradient-to-r from-[#ff2d95] to-[#8f4de0] px-6 py-3.5 font-semibold text-white transition-all hover:shadow-2xl hover:shadow-[#ff2d95]/30 active:scale-95">
        ...
        <div class="relative hidden w-1/2 overflow-hidden lg:flex lg:items-center lg:justify-center">
            ...
            <div class="relative z-10 text-center px-12">
                <div class="mb-8">
                    <img src="https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=400&h=300&fit=crop" alt="Streaming platform" class="rounded-2xl shadow-2xl mx-auto border border-white/10 w-64 h-48 object-cover">
                </div>
                <h2 class="mb-4 text-3xl font-bold bg-gradient-to-r from-[#ff2d95] via-[#8f4de0] to-[#ff6bb5] bg-clip-text text-transparent">Join the Community</h2>
                <p class="text-white/60 leading-relaxed max-w-sm mx-auto">Get access to exclusive content, personalized recommendations, and more.</p>
            </div>
        </div>
    </div>
</x-guest-layout>
